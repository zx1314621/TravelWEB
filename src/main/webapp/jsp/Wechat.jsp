...
<input type="hidden" name="payway" id="payway" value="微信">
<c:forEach var = "orderList" items = "${orderList}">

<tr>
    <td>${orderList.w_id }</td>
    <td>${orderList.fly_id }</td>
    <td>${orderList.company }</td>
    <td>${orderList.money }</td>
      <td>   <button class="layui-btn layui-btn-warm" name="add"  type="submit"  value="${orderList.w_id}"><i class="layui-icon">&#xe654;</i> 添加</button> 
      <button class="layui-btn layui-btn-normal layui-btn-mini news_del" id="edit" name="edit"  type="submit"  value="${orderList.w_id}"><i class="layui-icon">&#xe615;</i>编辑</button>
      <button class="layui-btn layui-btn-danger layui-btn-mini news_del" name="delete"    value="${orderList.w_id}"><i class="layui-icon">&#xe640;</i> 删除</button> </td>  
</tr>
</c:forEach>
</form>
  </tbody>
